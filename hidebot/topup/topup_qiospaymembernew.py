...
@bot.on(events.NewMessage(pattern='/topppnewmember'))
@bot.on(events.CallbackQuery(data=b'topppnewmember'))
async def topppnewmember_handler(event):
    chat = event.chat_id
