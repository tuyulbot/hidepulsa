...
@bot.on(events.CallbackQuery(data=b'dompull'))
async def dompull(event):
    logger.info(f"Command dompul dipanggil oleh {event.sender_id}")
...
async def handle_indosat(event):
    # Tombol menu
    inline = [
        [Button.inline("Dompul MyXL", b"ccek_kuota|cekdompul")],
        [Button.inline("Dompul Indosat", b"cek_dompul_isat|cekdompul_isat"),
        Button.inline("Dompul Tri", b"cek_dompul_tri|cekdompul_tri")],
