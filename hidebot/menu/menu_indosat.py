...
@bot.on(events.CallbackQuery(data=b'indosat'))
async def indosat(event):
    logger.info(f"Command indosat dipanggil oleh {event.sender_id}")
    ...
    await handle_indosat(event)  # pakai await biar langsung muncul respon

async def handle_indosat(event):
    # Tombol menu
    inline = [
        [Button.inline("Login", b"isat_login")],
        [Button.inline("Cek", b"cek_isat"),
        Button.inline("Beli By Category", b"bycategory_isat|Category")],
        [Button.inline("Edu Apps", b"bycode_isat|Edu Apps 30GB"),
        Button.inline("Masa Aktif", b"bycode_isat|Indosat Masa Aktif")],
...
@bot.on(events.CallbackQuery(data=b'cek_isat'))
async def cek_isat(event):
    ...
    await handle_cek_isat(event)  # pakai await biar langsung muncul respon

async def handle_cek_isat(event):
    # Tombol menu
    inline = [
        [Button.inline("Cek Kuota", b"cek_kuotaa_isat|cekkuota_isat"),
        Button.inline("Cek Pulsa", b"cek_kuotaa_isat|cekpulsa_isat")],
        [Button.inline("Back Menu", b"menu")],
    ]
