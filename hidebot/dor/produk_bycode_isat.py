...
@bot.on(events.CallbackQuery(pattern=b'bycode_isat\|(.+)'))
async def bycode_isat(event):
    ...
    if saldo < 10000:
        ...
        sid = f"bycode_isat:{secrets.token_hex(2)}"
    ...
    async with bot.conversation(chat) as conv:
        ...
        for i, p in enumerate(produk_list, start=1):
            ...
            harga_paket = get_harga_real_db(nama)
